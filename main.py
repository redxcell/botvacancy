...
Версия 2.1 - ИСПРАВЛЕНИЕ: return после каждого отклонения
"""
...
async def handle_text_message(message: Message, state: FSMContext):
    ...
    # ПРОВЕРКА 4: Наличие контактной информации
...
async def on_startup():
    ...
    logger.info("=" * 60)
    logger.info("🚀 Бот @DriverVakhtaBot запущен (v2.1)")
    logger.info("=" * 60)
